...
import mpicbg.stitching.math.OverlapProperties;
...
public class PointMatch {
    ...
    final public float[] getWeights() {
        return weights;
    }

    final public void setWeights(final float[] weights) {
    ...
    final public void setWeight(final int index, final float weight) {
     ...
     * Constructor
     *
     * Create a {@link PointMatch} with an Array of weights. The Array of
     * weights will be copied.
     *
     * @param p1
     *            Point 1
     * @param p2
     ...
     * @param amount
     */
    final public void applyByStrength(final Model model, final float amount) {
