...
public class TileConfiguration {
    ...
    final static private DecimalFormatSymbols decimalFormatSymbols =
            new DecimalFormatSymbols();

    final private ArrayList<Tile> tiles = new ArrayList<Tile>();

    final public ArrayList<Tile> getTiles() {
        return tiles;
    }

    final private ArrayList<Tile> fixedTiles = new ArrayList<Tile>();

    final public ArrayList<Tile> getFixedTiles() {
        return fixedTiles;
    }
    ...
    final public double getMinError() {
        return minError;
    }

    final public double getMaxError() {
        return maxError;
    }

    final public Tile getWorstError() {
        return worstTile;
    }

    final public double getAvgError() {
        return error;
    }
     ...
     * @param t
     */
    final public void addTile(final Tile t) {
        tiles.add(t);
    }
     ...
     * @param t
     */
    final public void addTiles(final Collection<Tile> t) {
        tiles.addAll(t);
    }
     ...
     * @param t
     */
    final public void fixTile(final Tile t) {
        fixedTiles.add(t);
    }
     ...
     *            convergence is reached if the average slope in an interval of
     *            this size is 0.0 (in double accuracy). This prevents the
     *            algorithm from stopping at plateaus smaller than this value.
     */
    public void optimize(final float maxAllowedError, final int maxIterations,
        ...
        Log.info("Successfully optimized configuration of " + tiles.size()
                + " tiles after " + i + " iterations:");
        Log.info("  average displacement: " + decimalFormat.format(error)
                + "px");
        Log.info("  minimal displacement: " + decimalFormat.format(minError)
                + "px");
        Log.info("  maximal displacement: " + decimalFormat.format(maxError)
                + "px");
    }
