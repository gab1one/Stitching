...
public class ComparePair {
    ...
    public ComparePair(final ImagePlusTimePoint impA,
    ...
    public ImagePlus getImagePlus1() {
        return impA.getImagePlus();
    }

    public ImagePlus getImagePlus2() {
        return impB.getImagePlus();
    }

    public int getTimePoint1() {
        return impA.getTimePoint();
    }

    public int getTimePoint2() {
        return impB.getTimePoint();
    }

    public Model<?> getModel1() {
        return impA.getModel();
    }

    public Model<?> getModel2() {
        return impB.getModel();
    }

    public void setCrossCorrelation(final float r) {
        crossCorrelation = r;
    }
    ...
    public void setRelativeShift(final float[] relativeShift) {
    ...
    public void setIsValidOverlap(final boolean state) {
        validOverlap = state;
    }
