...
public class ClassifiedRegionTest {
    ...
    private final Interval i1 = new Interval(0, 256);
    private final Interval i2 = new Interval(0, 128);
    private final Interval i3 = new Interval(0, 10);
    ...
    public void testRegionCreation() {
        // Use the empty constructor with subsequent set... calls (in mixed
        // order).
        final ClassifiedRegion region2 = new ClassifiedRegion(3);
        ...
        final ClassifiedRegion region3 = new ClassifiedRegion(region1);
    ...
    public void testIntersect() {
        ...
        region2 =
                new ClassifiedRegion(new Interval(256, 260), new Interval(128,
                        142), new Interval(10, 11));
        assertTrue(intersectingRegions(region1, region2));
    }
    ...
    public void testContainedIntersection() {
        final ClassifiedRegion region2 =
                new ClassifiedRegion(new Interval(1, 120),
                        new Interval(50, 75), new Interval(3, 6));
        assertTrue(intersectingRegions(region1, region2));
    }

    /**
     * Simple test of the
     * {@link ClassifiedRegion#equalsRegion(ClassifiedRegion)} method.
     */
    @Test
    public void testEqualRegions() {
        final ClassifiedRegion region2 =
                new ClassifiedRegion(new Interval(0, 256),
                        new Interval(0, 128), new Interval(0, 10));
     ...
     */
    private boolean intersectingRegions(final ClassifiedRegion region1,
            final ClassifiedRegion region2) {
        return region1.intersects(region2) && region2.intersects(region1);
    }

    /**
     * Test the {@link ClassifiedRegion#equalsRegion(ClassifiedRegion)} method
     * in both directions, to avoid bias.
     */
    private boolean equalRegions(final ClassifiedRegion region1,
            final ClassifiedRegion region2) {
